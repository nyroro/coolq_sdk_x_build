...
#define CQPLUS_API_INIT_PARAMS() \
    ...
    \
    Json::Value CQPLUS_API_ENV(Json::objectValue); \
    CQPLUS_API_ENV["CQ_HOME"] = cqplus::app::cq_home; \
    CQPLUS_API_ENV["CQ_APP_ID"] = cqplus::app::app_id; \
    CQPLUS_API_ENV["CQ_AUTH_CODE"] = cqplus::app::auth_code; \
    \
    Json::Value CQPLUS_API_PARAMS(Json::objectValue); \
    CQPLUS_API_PARAMS["env"] = CQPLUS_API_ENV;
